...
The colormap.nlogo model shows some examples of these functions in action. Please download both and put the in the same folder and open the colormap.nlogo file to run the examples.
Of course you can edit the colormap.nls file and add more palette reporters of any palettes you wish to use.

Stay tuned for more NetLogo and R related content ;)
