...
If you want to play around with the functions, you can check out the online [netlogoweb version](data/colormap_netlogoweb.html).

You can also download a NetLogo example model here:
